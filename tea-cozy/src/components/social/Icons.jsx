...
export function IconFacebook() {
  return (
    <a
      href="https://www.facebook.com/scott.milliorn"
      rel="noreferrer"
      aria-label="Facebook"
      target="_blank"
      className="mr-6 text-gray-600 hover:text-orange-50"
    >
      <svg
        aria-hidden="true"
        focusable="false"
...
export function IconInstagram() {
  return (
    <a
      href="https://www.instagram.com/psmilliorn"
      rel="noreferrer"
...
export function IconGithub() {
  return (
    <a
      ...
      rel="noreferrer"
      aria-label="github"
      className="text-gray-600 hover:text-orange-50"
      target="_blank"
    >
      <svg
        aria-hidden="true"
