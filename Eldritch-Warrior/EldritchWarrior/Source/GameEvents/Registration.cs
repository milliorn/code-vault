...
namespace EldritchWarrior.Source.Module
{
    public class Registration
    {
        ...
        public static void HookPlayerEvents()
        {
            ...
            SetEventScript(player, EventScriptType.Creature_OnHeartbeat, "pc_heartbeat");
            SetEventScript(player, EventScriptType.Creature_OnNotice, "pc_perception");
            SetEventScript(player, EventScriptType.Creature_OnSpellCastAt, "pc_spellcastat");
            SetEventScript(player, EventScriptType.Creature_OnMeleeAttacked, "pc_attacked");
            SetEventScript(player, EventScriptType.Creature_OnDamaged, "pc_damaged");
            SetEventScript(player, EventScriptType.Creature_OnDisturbed, "pc_disturb");
            SetEventScript(player, EventScriptType.Creature_OnEndCombatRound, "pc_roundend");
            SetEventScript(player, EventScriptType.Creature_OnSpawnIn, "pc_spawn");
            SetEventScript(player, EventScriptType.Creature_OnRested, "pc_rested");
            SetEventScript(player, EventScriptType.Creature_OnDeath, "pc_death");
            SetEventScript(player, EventScriptType.Creature_OnUserDefined, "pc_userdef");
            SetEventScript(player, EventScriptType.Creature_OnBlockedByDoor, "pc_blocked");
        }
        ...
        private static void HookModuleEvents()
        {
            ...
            SetEventScript(module, EventScriptType.Module_OnAcquireItem, "mod_acquire");
            SetEventScript(module, EventScriptType.Module_OnActivateItem, "mod_activate");
            SetEventScript(module, EventScriptType.Module_OnClientEnter, "mod_enter");
            SetEventScript(module, EventScriptType.Module_OnClientExit, "mod_exit");
            SetEventScript(module, EventScriptType.Module_OnPlayerCancelCutscene, "mod_abort_cs");
            SetEventScript(module, EventScriptType.Module_OnHeartbeat, "mod_heartbeat");
            SetEventScript(module, EventScriptType.Module_OnModuleLoad, "mod_load");
            SetEventScript(module, EventScriptType.Module_OnPlayerChat, "mod_chat");
            SetEventScript(module, EventScriptType.Module_OnPlayerDying, "mod_dying");
            SetEventScript(module, EventScriptType.Module_OnPlayerDeath, "mod_death");
            SetEventScript(module, EventScriptType.Module_OnEquipItem, "mod_equip");
            SetEventScript(module, EventScriptType.Module_OnPlayerLevelUp, "mod_level_up");
            SetEventScript(module, EventScriptType.Module_OnRespawnButtonPressed, "mod_respawn");
            SetEventScript(module, EventScriptType.Module_OnPlayerRest, "mod_rest");
            SetEventScript(module, EventScriptType.Module_OnUnequipItem, "mod_unequip");
            SetEventScript(module, EventScriptType.Module_OnLoseItem, "mod_unacquire");
            SetEventScript(module, EventScriptType.Module_OnUserDefined, "mod_user_def");
        }
        ...
        private static void HookAreaEvents()
        {
            ...
            {
                SetEventScript(area, EventScriptType.Area_OnEnter, "area_enter");
                SetEventScript(area, EventScriptType.Area_OnExit, "area_exit");
                SetEventScript(area, EventScriptType.Area_OnHeartbeat, "area_heartbeat");
                SetEventScript(area, EventScriptType.Area_OnUserDefined, "area_user_def");
            }
        }
