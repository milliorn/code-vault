namespace EldritchWarrior.Source.Module
{
    public static class Random
    {
        ...
        public static int D2(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 2);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D3(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 3);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D4(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 4);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D6(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 6);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D8(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 8);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D10(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 10);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D12(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 12);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D20(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 20);
        ...
        /// <param name="minimum">The minimum value.</param>
        /// <returns>A random value selected base on the parameters.</returns>
        public static int D100(int numberOfDice, int minimum = 1) => RollDice(numberOfDice, minimum, 100);
    }
}