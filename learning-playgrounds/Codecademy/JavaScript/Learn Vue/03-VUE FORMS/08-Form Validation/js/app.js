/*
In app.js, add a computed property called formIsValid that checks that all of our required fields are filled in.
To do this, make the following function the value of formIsValid:
*/
