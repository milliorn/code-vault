...
In app.js, add a data property to your Vue app called requiredFieldClass
with a value of the string 'required' (the name of the class).

In app.js, add a computed property called emailClasses with a value of the following function:
This code will make the value of emailClasses a class object that will add the touched class if
anything has been written in the “Email” field and will add the invalid class if an invalid email
has been written in the “Email” field.
*/
