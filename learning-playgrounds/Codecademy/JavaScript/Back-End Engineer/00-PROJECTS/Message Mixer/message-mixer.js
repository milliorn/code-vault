...
function getEncryptionMethod() {
	...
	if (encryptionType === "symbol") {
		encryption = symbolCipher;
	} else if (encryptionType === "reverse") {
		encryption = reverseCipher;
		...
		encryption = (str) => caesarCipher(str, amount);
	} else {
...
function displayEncryptedMessage(encryption, userInput) {
	let str = userInput.toString().trim();
	let output = encryption(str);
