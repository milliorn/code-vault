...
function testMergeTwoLists() {
    ...
    console.assert(
        JSON.stringify(linkedListToArray(mergedList)) === JSON.stringify([1, 1, 2, 3, 4, 4]),
        'Test case 1 failed'
    );
    ...
    console.assert(
        JSON.stringify(linkedListToArray(mergedList)) === JSON.stringify([]),
        'Test case 2 failed'
    );
    ...
    mergedList = mergeTwoLists(list1, list2);
    console.assert(
        JSON.stringify(linkedListToArray(mergedList)) === JSON.stringify([0]),
        'Test case 3 failed'
    );
